// ==UserScript==
// @name         EdgeX Arbitrage Frontend
// @namespace    http://tampermonkey.net/
// @version      1.0
// @description  EdgeX-Lighter 套利系统前端脚本
// @author       You
...
(async function() {
    ...
    // ===============================================
    // WebSocket 桥接 (与后端通信) - 使用原生 WebSocket
    // Tampermonkey 的 @connect 声明允许绕过 CSP
    // ===============================================
    class WebSocketBridge {
        ...
        async connect() {
            return new Promise((resolve, reject) => {
                try {
                    ...
                    // 直接使用 WebSocket - Tampermonkey 的 @connect 应该允许这个连接
        ...
        attemptReconnect() {
            ...
            log('info', `Reconnecting in ${delayMs}ms (attempt ${this.reconnectAttempts})`);
